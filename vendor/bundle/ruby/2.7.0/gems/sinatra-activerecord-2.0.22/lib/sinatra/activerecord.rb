...
module Sinatra
  ...
  module ActiveRecordExtension
    def self.registered(app)
      if ENV['DATABASE_URL'] && File.exist?("#{Dir.pwd}/config/database-mysql.yml")
        path = "#{Dir.pwd}/config/database-mysql.yml"
      ...
      elsif File.exist?("#{Dir.pwd}/config/database-mysql.yml")
        app.set :database_file, "#{Dir.pwd}/config/database-mysql.yml"
      end
