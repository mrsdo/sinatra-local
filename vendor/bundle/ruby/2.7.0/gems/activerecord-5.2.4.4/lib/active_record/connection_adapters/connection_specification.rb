        ...
        def spec(config)
          ...
          begin
            ...
            if e.path == path_to_adapter
              ...
              raise LoadError, "Could not load the '#{spec[:adapter]}' Active Record adapter. Ensure that the adapter is spelled correctly in config/database-mysql.yml and that you've added the necessary adapter gem to your Gemfile.", e.backtrace
